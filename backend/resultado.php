  ...
  <body>
    ...
    // Se ainda não tiver realizado a triagem, pede os dados
      ...
      <form action="resultado.php" method="post">
        ...
        <input type="hidden" name="bpm" value=" <?php echo $tri->getBatimento() ?>">
